...
if ( ! class_exists( 'Give_Export_Donations_Fee_Recovery_Details' ) ) {
	...
	class Give_Export_Donations_Fee_Recovery_Details {
		...
		public function __construct() {
			add_action( 'give_export_donation_add_custom_column', array( $this, 'add_fee_recovery_fields_to_export_list' ) );
		...
		public function add_fee_recovery_fields_to_export_list() {
			?>
			<li class="give-export-option-fields give-export-option-fee-recovery-fields">
				<ul class="give-export-option-fee-recovery-fields-ul">
					<li class="give-export-option-label give-export-option-fee-recovery-label">
						<span>
							<?php _e( 'Fee Recovery Fields', 'give-fee-recovery' ); ?>
						</span>
					</li>
